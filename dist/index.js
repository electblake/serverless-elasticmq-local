...
/***/ "./node_modules/sqs-localhost/dist/index.js":
/*!**************************************************!*\
  !*** ./node_modules/sqs-localhost/dist/index.js ***!
  \**************************************************/
/*! no static exports found */
...
/*!******************!*\
  !*** ./index.ts ***!
  \******************/
/*! exports provided: SQSLocal, default, installSQSLocal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SQSLocal", function() { return SQSLocal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "installSQSLocal", function() { return installSQSLocal; });
...
const Q = __webpack_require__(/*! q */ "./node_modules/q/q.js");
const debug = __webpack_require__(/*! debug */ "./node_modules/debug/src/index.js")('sqs-local');
const JARNAME = 'elasticmq-server-0.14.6.jar';
const Config = {
    installPath: path__WEBPACK_IMPORTED_MODULE_4__["join"](os__WEBPACK_IMPORTED_MODULE_0__["tmpdir"](), 'sqs-local'),
    downloadUrl: 'https://s3-eu-west-1.amazonaws.com/softwaremill-public/' + JARNAME,
};
...
const SQSLocal = {
    ...
    launch: function (port, dbPath, additionalArgs, verbose = false, detached) {
        ...
        return installSQSLocal().then(function () {
            var args = ['-Xrs', '-Djava.library.path=./SQSLocal_lib', '-jar', JARNAME, '-port', port];
            args = args.concat(additionalArgs);
            var child = Object(child_process__WEBPACK_IMPORTED_MODULE_2__["spawn"])('java', args, {
            ...
            if (verbose) {
                debug('SQSLocal(', child.pid, ') started on port', port, 'via java', args.join(' '), 'from CWD', Config.installPath);
            }
            return child;
        });
    },
...
/* harmony default export */ __webpack_exports__["default"] = (SQSLocal);
function installSQSLocal() {
    debug('Checking for SQS-Local in ', Config.installPath);
    //   var filebuf = []
    var deferred = Q.defer();
    try {
        if (fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"](path__WEBPACK_IMPORTED_MODULE_4__["join"](Config.installPath, JARNAME))) {
            return Q.fcall(function () {
                return true;
            });
        }
    ...
    debug('SQS Local not installed. Installing...');
    if (!fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"](Config.installPath))
        fs__WEBPACK_IMPORTED_MODULE_1__["mkdirSync"](Config.installPath);
    if (fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"](Config.downloadUrl)) {
        debug('Installing from local file:', Config.downloadUrl);
        const filebuf = fs__WEBPACK_IMPORTED_MODULE_1__["createReadStream"](Config.downloadUrl);
        filebuf
            .on('end', function () {
            deferred.resolve();
        })
        ...
        https__WEBPACK_IMPORTED_MODULE_3__["get"](Config.downloadUrl, function (redirectResponse) {
            if (200 != redirectResponse.statusCode) {
                deferred.reject(new Error('Error getting SQS local latest tar.gz location ' +
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: ServerlessSQSLocal, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ServerlessSQSLocal", function() { return ServerlessSQSLocal; });
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! path */ "path");
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var sqs_localhost__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! sqs-localhost */ "./node_modules/sqs-localhost/dist/index.js");
/* harmony import */ var sqs_localhost__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(sqs_localhost__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_2__);



class ServerlessSQSLocal {
    constructor(serverless, options) {
        this.serverless = serverless;
        this.service = serverless.service;
        this.serverlessLog = serverless.cli.log.bind(serverless.cli);
        this.config = (this.service.custom && this.service.custom['sqs']) || {};
        this.sqsLocal = new sqs_localhost__WEBPACK_IMPORTED_MODULE_1___default.a();
        this.options = lodash__WEBPACK_IMPORTED_MODULE_2___default.a.merge({
            installPath: serverless.config && path__WEBPACK_IMPORTED_MODULE_0__["join"](serverless.config.servicePath, '.sqs'),
        }, options);
        this.provider = 'aws';
        this.commands = {
            sqs: {
    ...
    get port() {
        ...
        const port = lodash__WEBPACK_IMPORTED_MODULE_2___default.a.get(config, 'start.port', 8000);
        return port;
    }
    get host() {
        const config = (this.service.custom && this.service.custom.sqs) || {};
        const host = lodash__WEBPACK_IMPORTED_MODULE_2___default.a.get(config, 'start.host', 'localhost');
        return host;
    }
    /**
     * Get the stage
    ...
    removeHandler() {
        return new Promise((resolve) => this.sqsLocal.remove(resolve));
    }
    ...
    startHandler() {
        if (this.shouldExecute()) {
            const config = (this.service.custom && this.service.custom.sqs) || {};
            const options = lodash__WEBPACK_IMPORTED_MODULE_2___default.a.merge({
            ...
            if (dbPath) {
                options.dbPath = path__WEBPACK_IMPORTED_MODULE_0__["isAbsolute"](dbPath) ? dbPath : path__WEBPACK_IMPORTED_MODULE_0__["join"](this.serverless.config.servicePath, dbPath);
            }
            if (!options.noStart) {
                this.sqsLocal.start(options);
            }
    ...
    getDefaultStack() {
        return lodash__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.service, 'resources');
    }
    getAdditionalStacks() {
        return lodash__WEBPACK_IMPORTED_MODULE_2___default.a.values(lodash__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.service, 'custom.additionalStacks', {}));
    }
    hasAdditionalStacksPlugin() {
        return lodash__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.service, 'plugins', []).includes('serverless-plugin-additional-stacks');
    }
    getTableDefinitionsFromStack(stack) {
        const resources = lodash__WEBPACK_IMPORTED_MODULE_2___default.a.get(stack, 'Resources', []);
...
/* harmony default export */ __webpack_exports__["default"] = (ServerlessSQSLocal);
